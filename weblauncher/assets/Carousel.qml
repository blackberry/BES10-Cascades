...
Container {
    ...
    Container {
        ...
        CarouselItem {
            id: bbNDA
            objectName: "http://developer.blackberry.com"
            centered: true
        ...
        CarouselItem {
            id: bbBreak
            objectName: "http://developer.blackberry.com/html5"
            angle: root.angle + root.baseAngle
            imgFileName: "images/bg2.png"
        }
        CarouselItem {
            id: bbInstall
            objectName: "http://developer.blackberry.com/cascades"
            angle: root.angle + root.baseAngle
            imgFileName: "images/bg3.png"
        }
        CarouselItem {
            id: bbFeature
            objectName: "http://developer.blackberry.com/native"
            angle: root.angle + root.baseAngle
            imgFileName: "images/bg6.png"
        }
        CarouselItem {
            id:  bbFuture
            objectName: "bbFuture"
            angle: root.angle + root.baseAngle
            imgFileName: "images/bgN.png"
        }
//        CarouselItem {
//            id: my5
//            angle: root.angle + root.baseAngle
