...
Page {
                ...
                ListView {
                    ...
                    onTriggered: {
                        ...
                        if (indexPath == 0) {}
                            ...
                            for (var i = 2; i < beerDataModel.size(); i ++) {
                    ...
                    function itemType(data, indexPath) {
                        if (indexPath == 0) return "header";
                        else if (indexPath == 1) return "summary";
                        return "item";
                    }
                    function getItem() {
                    ...
                    function getAverage() {
                        console.log(" getAverage = "  + averageQuantity)
                    ...
                    listItemComponents: [
                        ListItemComponent {
                            ...
                            item: ListItem.view.getItem()
                            myapp: ListItem.view.getApp()
                            }
                        },
                        ListItemComponent {
                            type: "summary"
    ...
    actions: [
        ...
        ActionItem {
            ...
            onTriggered: {
                dialNumber.initiateCall(app.contactMap.Phone);
            }
        },
        ActionItem {
            title: qsTr("BBM")
    ...
    attachedObjects: [
        ...
        DataRequest {
            ...
            onDataReturned: {
                ...
                beerDataModel.clear()
                beerDataModel.append({itemType: "header"})
