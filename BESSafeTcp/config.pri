...
config_pri_source_group1 {
    ...
    HEADERS += \
        $$quote($$BASEDIR/src/BESConnect.hpp) \
        $$quote($$BASEDIR/src/BESSafeTcp.hpp) \
        $$quote($$BASEDIR/src/curlConnectThread.hpp) \
        $$quote($$BASEDIR/src/sslSocketThread.hpp) \
        $$quote($$BASEDIR/src/tcpSocketThread.hpp)
}
