        ...
        <table class="style1">
            ...
            <tr>
                <td colspan="2" width="5%">
                    <fieldset><legend>Add A Server To Monitor</legend>
                            <table class="style1">
                                <tr>
                    ...
                    <tr>
                        <td align="left" width="25%">
                            <asp:Label ID="Label2" runat="server" style="text-align: right" Text="Notify: "
                                Width="20%"></asp:Label>
                            <asp:TextBox ID="tbRecipient" runat="server" Width="78%" ToolTip="Recipient Pin or Email Address"></asp:TextBox>
                        </td>
                        <td width="25%" align="left">
                            <asp:Label ID="Label3" runat="server" style="text-align: right" Text="BES: "
                                Width="15%"></asp:Label>
                            <asp:TextBox ID="tbBesName" runat="server" Width="83%" ToolTip="Logical name of BES e.g. BES0001-32"></asp:TextBox>
                        </td>
                        <td width="25%" align="left">
                            <asp:Label ID="Label4" runat="server" style="text-align: right"
                                Text="BES Push Port: " Width="35%"></asp:Label>
                            <asp:TextBox ID="tbPushPort" runat="server" Width="63%" ToolTip="E.g. 8080"></asp:TextBox>
                        </td>
                        <td width="25%" align="left">
                            <asp:Label ID="Label1" runat="server" Text="Interval (s): "
                                style="text-align: right" Width="30%"></asp:Label>
                            <asp:TextBox ID="tbTimerInterval" runat="server" Width="68%" ToolTip="Freqency to check status of server">10</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
